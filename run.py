...
def get_sales_data():
    ...
    via the terminal, which must be 5 numbers separated by commas.
    the loop will repetedly request data until it is valid.
    """
    while True:
        print("Please enter sales data from the last market.")
        print("Data should be six numbers, seperarated by commas.")
...
def update_worksheet(data, worksheet):
    """
    Recives a list of integers to be inserted into the worksheet
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtracted from the the stock:
...
def calculate_stock_data(data):
    """
    Calculate the average stockfor each item type, adding 10%
    """
